...
namespace Ramune.RamunesOutcrops.Outcrops
{
    public static class BreakableData
    {
        ...
        {
            new() { prefabReference = new AssetReferenceGameObject("76dbf26f5fa205e4b87888f4a05c45ae"), prefabTechType = TechType.Diamond, chance = 0.33f },
        ...
        public static List<BreakableResource.RandomPrefab> Serpentite = new()
        {
            ...
            new() { prefabReference = new AssetReferenceGameObject("b3b8aabaa22aa1b48a7d69a7517cabde"), prefabTechType = TechType.Silver, chance = 0.33f },
            new() { prefabReference = new AssetReferenceGameObject("76dbf26f5fa205e4b87888f4a05c45ae"), prefabTechType = TechType.Diamond, chance = 0.33f },
        };
    }
}