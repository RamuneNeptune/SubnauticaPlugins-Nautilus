...
namespace Ramune.RamunesOutcrops.Data
{
    public static class BiomeData
    {
        ...
        {
            { BiomeType.MushroomForest_GiantTreeInteriorFloor, (1, 0.3f) },
            { BiomeType.MushroomForest_MushroomTreeTrunk,      (1, 0.3f) },
            { BiomeType.MushroomForest_CaveCeiling,            (1, 0.3f) },
            { BiomeType.MushroomForest_CaveFloor,              (1, 0.3f) },
            { BiomeType.MushroomForest_RockWall,               (1, 0.3f) },
            { BiomeType.MushroomForest_CaveWall,               (1, 0.3f) },
            { BiomeType.MushroomForest_Sand,                   (1, 0.3f) },
        };

        public static Dictionary<BiomeType, (int, float)> Serpentite = new Dictionary<BiomeType, (int, float)>()
        {
            { BiomeType.LostRiverCorridor_Ceiling, (1, 0.3f) },
            { BiomeType.LostRiverCorridor_Wall,    (1, 0.3f) },
            { BiomeType.LostRiverJunction_Ceiling, (1, 0.3f) },
            { BiomeType.LostRiverJunction_Wall,    (1, 0.3f) },
            { BiomeType.BloodKelp_TrenchFloor,     (1, 0.3f) },
            { BiomeType.BloodKelp_TrenchWall,      (1, 0.3f) },
            { BiomeType.BloodKelp_CaveFloor,       (1, 0.3f) },
            { BiomeType.BloodKelp_CaveWall,        (1, 0.3f) },
            { BiomeType.BloodKelp_Grass,           (1, 0.3f) },
            { BiomeType.BloodKelp_Floor,           (1, 0.3f) },
            { BiomeType.BloodKelp_Wall,            (1, 0.3f) },
        };
    }
}